...
export declare interface CustomizedLoginOptions
  extends Omit<
    BaseOptions,
    'usernameField' | 'usernameSubmitBtn' | 'passwordField' | 'passwordSubmitBtn'
  > {
  usernameField: string
  usernameSubmitBtn: string
  passwordField: string
...
export declare function CustomizedLogin(
  options: CustomizedLoginOptions
